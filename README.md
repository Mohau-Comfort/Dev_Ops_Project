...
- Learn how to manage source code using Git & GitHub
- Build and automate CI/CD pipelines
- Containerize applications using Docker
- Understand Kubernetes basics for container orchestration
- Explore Infrastructure as Code (IaC) concepts
- Deploy APIs in an automated and repeatable way
...
- Docker
- Kubernetes
- Cloud / local deployment tools
- Environment configuration and automation scripts

> ⚠️ Note: This repository will evolve as more concepts are introduced and implemented.
